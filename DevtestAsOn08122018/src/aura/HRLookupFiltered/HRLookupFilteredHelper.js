({
    ...
    searchSOSLHelper : function (component,searchText) {
        ...
        if(searchText && searchText.length > 3){
            ...
            console.log('searchinputHelper ' + searchText);
            ...
            action.setCallback(this, function(response){
                ...
                if(component.isValid() && state === "SUCCESS") {
                    ...
                    //var result = [].concat.apply([], JSON.stringify(a.getReturnValue()));
                    console.log('SR ' + response.getReturnValue());
                    var result = response.getReturnValue();
                    component.set("v.matchingRecords", result);
                    console.log('Searched Records ' + JSON.stringify(component.get("v.matchingRecords")));
        ...
        action.setCallback(this, function(response) {
            ...
            if(component.isValid() && state === "SUCCESS") {
                if(response.getReturnValue()){
                    component.set("v.matchingRecords", JSON.stringify(response.getReturnValue()));
                    console.log('Recent Records1 ' + component.get("v.matchingRecords").Name);
