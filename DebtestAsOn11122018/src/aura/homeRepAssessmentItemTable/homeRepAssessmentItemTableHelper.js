({
	...
	fireHandleAssessmentItemsEvent : function(component, command) {
        var handleAssessmentItems = component.getEvent("handleAssessmentItems"); 
        handleAssessmentItems.setParams({
            "command": command
        });
        handleAssessmentItems.fire();
	}
})